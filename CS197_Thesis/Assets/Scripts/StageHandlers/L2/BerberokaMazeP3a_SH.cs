...
public class BerberokaMazeP3a_SH : MonoBehaviour
{
    private static BerberokaMazeP3a_SH stageHandler;

    public static BerberokaMazeP3a_SH getInstance()
    {
        return stageHandler;
    }
    ...
    void Start()
    {
        ...
        playerCharacter.UpdatePosition(116);
